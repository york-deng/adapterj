...
public class SimpleListAdapter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.adapterj.widget.SimpleListAdapter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SimpleListAdapter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.adapterj.exceptions.NotImplementedException",
      ...
      "com.adapterj.widget.Text",
      "com.google.gson.stream.JsonReader",
      "com.adapterj.annotation.ID",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SimpleListAdapter_ESTest_scaffolding.class.getClassLoader()); 
