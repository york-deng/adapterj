 ...
 */
public class SimpleHTMLViewV4 extends AbstractView {

	private static final boolean DEBUG = Debugger.DEBUG ? false : false;
	
    private static final String TAG = SimpleHTMLViewV4.class.getName();
	 ...
	 */
	public SimpleHTMLViewV4(final String acceleratorClass) {
	 ...
	 */
	public SimpleHTMLViewV4(final String acceleratorClass, final Document document) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
