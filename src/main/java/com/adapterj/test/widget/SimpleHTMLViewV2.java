 ...
 * 生成基于 List<String> 或 List<List<String>> 的动态方法，以及基于 FIELD-COPY 在 ClassLoader 之间共享数据。
 * 
 ...
 */
public class SimpleHTMLViewV2 extends AbstractView {

	private static final boolean DEBUG = Debugger.DEBUG ? false : false;
	
    private static final String TAG = SimpleHTMLViewV2.class.getName();
	 ...
	 */
	public SimpleHTMLViewV2(final String acceleratorClass) {
	 ...
	 */
	public SimpleHTMLViewV2(final String acceleratorClass, final Document document) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
