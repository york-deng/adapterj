 ...
 */
public class SimpleHTMLView6 extends AbstractView implements Javable, Formattable {
    ...
    private static final String TAG = SimpleHTMLView6.class.getName();
	 ...
	 * @param writeFile
	 */
	public SimpleHTMLView6(final Boolean writeFile) {
		try {
			_acceleratorClass = SimpleHTMLViewAcceleratorV2.class.getName();
	 ...
	 */
	public SimpleHTMLView6(final String acceleratorClass) {
	 ...
	 * @param writeFile
	 */
	public SimpleHTMLView6(final String acceleratorClass, final Boolean writeFile) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
	 ...
	 */
	public SimpleHTMLView6(final Document document, final String md5) {
		if (document == null) {
	 ...
	 */
	public SimpleHTMLView6(final String acceleratorClass, final Document document, final String md5) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
	 ...
	 * @param md5 The MD5 of HTML template file
	 */
	public SimpleHTMLView6(final String acceleratorClass, final Boolean writeFile, final Document document, final String md5) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
