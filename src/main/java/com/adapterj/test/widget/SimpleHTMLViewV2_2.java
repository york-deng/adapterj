 ...
 */
public class SimpleHTMLViewV2_2 extends AbstractView {

	private static final boolean DEBUG = Debugger.DEBUG ? false : false;
	
    private static final String TAG = SimpleHTMLViewV2_2.class.getName();
	 ...
	 */
	public SimpleHTMLViewV2_2(final String acceleratorClass) {
	 ...
	 */
	public SimpleHTMLViewV2_2(final String acceleratorClass, final Document document) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
...
//					//t.putList1(id2, f.getList1(id2));
//					boost.getClass().getDeclaredMethod("test");
//					
//					Method[] methods = boost.getClass().getSuperclass().getDeclaredMethods();
//					for (Method method : methods) {
//						Log.i(TAG, method.getName());
//						Log.i(TAG, method.toGenericString());
