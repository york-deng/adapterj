 ...
 */
public class SimpleHTMLViewV3_2 extends AbstractView {

	private static final boolean DEBUG = Debugger.DEBUG ? false : false;
	
    private static final String TAG = SimpleHTMLViewV3_2.class.getName();
	 ...
	 */
	public SimpleHTMLViewV3_2(final String acceleratorClass) {
	 ...
	 */
	public SimpleHTMLViewV3_2(final String acceleratorClass, final Document document) {
		if (acceleratorClass == null) {
			throw new IllegalArgumentException("accelerator class is null");
		}
